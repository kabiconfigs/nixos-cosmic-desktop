...

{
  ...
  programs.bash = {
    ...
    bashrcExtra = ''
      export PATH="$PATH:$HOME/bin:$HOME/.local/bin:/$HOME/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin"
    '';
  };
  ...
  programs.kitty = {
   ...
   settings = {
    ...
    background_blur = 5;
    font = with pkgs; "nerd-fonts.jetbrains-mono";
   };
   extraConfig = ''
    editor nano
    shell .
...
xdg.configFile."fastfetch/config.jsonc".text = ''
{
  ...
  "modules": [
    ...
    { "type": "gpu", "key": "󰤽" },
    { "type": "memory", "key": "" },
    { "type": "disk", "key": "", "folders": ["/", "/media/Data"] },
    "break",
    {
      "type": "colors",
      "paddingLeft": 4,
